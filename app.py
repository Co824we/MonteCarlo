...
st.markdown(
    f"The projection overlay compares normal compounding against a scenario where the account sits in cash for the first {sitout_months} months, then resumes trading."
)
...
fig_1yr = make_projection_chart(paths_1yr_full, paths_1yr_sitout, last_date, years=1, sitout_months=sitout_months)
...
fig_10yr = make_projection_chart(paths_10yr_full, paths_10yr_sitout, last_date, years=10, sitout_months=sitout_months)
